...
public class weight_conv extends AppCompatActivity {
    ...
    String[] units = {"Milligrams (mg)", "Grams (g)", "Kilograms (kg)", "Tons (t)", "Quintal (q)", "Pound (lb)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_conv = findViewById(R.id.txt_enter_weight);
        output_conv = findViewById(R.id.txt_converted_weight);
        ...
        list_from.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (fromIndex == 0 && toIndex == 0) {
                    ...
                    outputValue = inputValue * 0.0000022046226 ;
                }
                    ...
                    outputValue = inputValue * 0.0022046226;
                }
                    ...
                    outputValue = inputValue * 2.2046226;
                }
                    ...
                    outputValue = inputValue * 2204.6226;
                }
                    ...
                    outputValue = inputValue * 220.46226;
                }

                else if (fromIndex == 5 && toIndex == 0) {
                    outputValue = inputValue * 453592.374495299;
                } else if (fromIndex == 5 && toIndex == 1) {
                    outputValue = inputValue * 453.592374495299;
                } else if (fromIndex == 5 && toIndex == 2) {
                    outputValue = inputValue * 0.453593274495299;
                } else if (fromIndex == 5 && toIndex == 3) {
                    outputValue = inputValue * 0.000453593274495299;
                } else if (fromIndex == 5 && toIndex == 4) {
                    outputValue = inputValue * 0.00453593274495299;
