...
public class memory_conv extends AppCompatActivity {
    ...
    String[] units = {"Bits", "Byte", "Kilobytes (KB)", "Megabytes (MB)", "Gigabytes (GB)", "Terabytes (TB)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_conv);
        ...
        input_conv = findViewById(R.id.txt_enter_memory);
        output_conv = findViewById(R.id.txt_converted_memory);
        ...
        list_from.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (fromIndex == 0 && toIndex == 0) {
                    ...
                    outputValue = inputValue*0.125;
                } else if (fromIndex == 0 && toIndex == 2) {
                    outputValue = inputValue * 0.0001220703125;
                } else if (fromIndex == 0 && toIndex == 3) {
                    outputValue = inputValue * 1.1920928955078125e-7;
                } else if (fromIndex == 0 && toIndex == 4) {
                    outputValue = inputValue * 1.1641532182693481e-10;
                } else if (fromIndex == 0 && toIndex == 5) {
                    outputValue = inputValue * 1.1368683772161603e-13;
                }
                ...
                if (fromIndex == 1 && toIndex == 0) {
                    ...
                    outputValue = inputValue * 0.0009765625;
                } else if (fromIndex == 1 && toIndex == 3) {
                    outputValue = inputValue * 9.5367431640625e-7;
                } else if (fromIndex == 1 && toIndex == 4) {
                    outputValue = inputValue * 9.313225746154785e-10;
                } else if (fromIndex == 1 && toIndex == 5) {
                    outputValue = inputValue * 9.094947017729282e-13;
                }

                if (fromIndex == 2 && toIndex == 0) {
                    outputValue = inputValue*8192;
                ...
                if (fromIndex == 3 && toIndex == 0) {
                    outputValue = inputValue*8388608;
                ...
                if (fromIndex == 4 && toIndex == 0) {
                    outputValue = inputValue*8589934592.0;
                ...
                if (fromIndex == 5 && toIndex == 0) {
                    outputValue = inputValue * 8796093022208.0;
                } else if (fromIndex == 5 && toIndex == 1) {
                    outputValue = inputValue * 1099511627776.0;
