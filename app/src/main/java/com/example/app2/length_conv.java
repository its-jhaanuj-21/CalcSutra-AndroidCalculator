...
public class length_conv extends AppCompatActivity{
    ...
    TextView from_unit, to_unit;

    String data;
    boolean isOperatorPressed = false;

    String[] units = {"Decimeters (dm)", "Millimeters (mm)", "Centimeters (cm)", "Meters (m)", "Kilometers (km)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_conv = findViewById(R.id.txt_enter_length);
        output_conv = findViewById(R.id.txt_converted_length);
