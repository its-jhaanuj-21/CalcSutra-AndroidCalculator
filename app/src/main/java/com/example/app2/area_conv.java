...
public class area_conv extends AppCompatActivity {
    ...
    String[] units = {"Square Meter (m²)", "Square Centimeter (cm²)", "Square Kilometer (km²)","Square Millimeter (mm²)","Square Foot (ft²)", "Hectare (ha)", "Acre (ac)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_conv = findViewById(R.id.txt_enter_area);
        output_conv = findViewById(R.id.txt_converted_area);
        ...
        list_from.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (fromIndex == 2 && toIndex == 0) {
                    ...
                    outputValue = inputValue * 10763910.4;
                } else if (fromIndex == 2 && toIndex == 5) {
                    outputValue = inputValue * 100;
                } else if (fromIndex == 2 && toIndex == 6) {
                    outputValue = inputValue * 247.1;
                }
                ...
                if (fromIndex == 3 && toIndex == 0) {
                    ...
                    outputValue = inputValue * 0.0000107639104;
                } else if (fromIndex == 3 && toIndex == 5) {
                    outputValue = inputValue * 1e-10;
                } else if (fromIndex == 3 && toIndex == 6) {
                    outputValue = inputValue * 2.471e-10;
                }


                if (fromIndex == 4 && toIndex == 0) {
                    outputValue = inputValue*0.092903040144221;
                } else if (fromIndex == 4 && toIndex == 1) {
                    outputValue = inputValue*929.03040144221;
                } else if (fromIndex == 4 && toIndex == 2) {
                    outputValue = inputValue * 9.2903040144221e-8;
                } else if (fromIndex == 4 && toIndex == 3) {
                    outputValue = inputValue*92903.040144221;
                } else if (fromIndex == 4 && toIndex == 4) {
                    outputValue = inputValue;
                } else if (fromIndex == 4 && toIndex == 5) {
                    outputValue = inputValue * 0.0000092903040144221;
                } else if (fromIndex == 4 && toIndex == 6) {
                    outputValue = inputValue * 0.0000229563412196370091;
                }
                ...
                if (fromIndex == 5 && toIndex == 0) {
                    ...
                    outputValue = inputValue * 107639.104;
                } else if (fromIndex == 5 && toIndex == 5) {
                    outputValue = inputValue;
                } else if (fromIndex == 5 && toIndex == 6) {
                    outputValue = inputValue * 2.471;
                }


                if (fromIndex == 6 && toIndex == 0) {
                    outputValue = inputValue*4046.944556859571024;
                } else if (fromIndex == 6 && toIndex == 1) {
                    outputValue = inputValue*40469445.56859571024;
                } else if (fromIndex == 6 && toIndex == 2) {
                    outputValue = inputValue * 0.004046944556859571024;
                } else if (fromIndex == 6 && toIndex == 3) {
                    outputValue = inputValue*4046944556.859571024;
                } else if (fromIndex == 6 && toIndex == 4) {
                    outputValue = inputValue*43560.9486038041278847722496;
                } else if (fromIndex == 6 && toIndex == 5) {
                    outputValue = inputValue*0.4046944556859571024;
